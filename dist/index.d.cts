...
interface ParentConfig<T> {
     ...
     */
    dragstartClasses: (node: NodeRecord<T>, nodes: Array<NodeRecord<T>>, config: ParentConfig<T>) => void;
    ...
    handleFocusParent: (data: ParentEventData<T>, state: BaseDragState<T>) => void;
    handleKeydownNode: (data: NodeEventData<T>, state: DragState<T>) => void;
    handleKeydownParent: (data: ParentKeydownEventData<T>, state: DragState<T>) => void;
    /**
     * Function that is called when dragend or touchend event occurs.
     */
    handleEnd: (data: NodeDragEventData<T> | NodePointerEventData<T>, state: DragState<T>) => void;
    /**
     * Function that is called when dragstart event occurs.
     */
    handleDragstart: (data: NodeDragEventData<T>, state: DragState<T>) => void;
    handlePointerupNode: (data: NodePointerEventData<T>, state: DragState<T>) => void;
    /**
     * Function that is called when touchstart event occurs.
     */
    handleTouchstart: (data: NodePointerEventData<T>, state: DragState<T>) => void;
    /**
     * Function that is called when a dragenter event is triggered on the node.
     */
    handleDragenterNode: (data: NodeDragEventData<T>, state: DragState<T>) => void;
    /**
     * Dragleave event on node
     */
    handleDragleaveNode: (data: NodeDragEventData<T>, state: DragState<T>) => void;
    /**
     * Function that is called when a dragover event is triggered on the parent.
     */
    handleDragoverParent: (data: ParentDragEventData<T>, state: DragState<T>) => void;
    /**
    ...
    handlePointerdownNode: (data: NodePointerEventData<T>, state: DragState<T>) => void;
    /**
     ...
     */
    handlePointermove: (data: NodePointerEventData<T>, state: DragState<T>) => void;
    /**
     * Function that is called when a node that is being moved by touchmove event
     * is over a given node (similar to dragover).
     */
    handlePointeroverNode: (data: PointeroverNodeEvent<T>, state: DragState<T>) => void;
    /**
     * Function that is called when a node that is being moved by touchmove event
     * is over the parent (similar to dragover).
     */
    handlePointeroverParent: (e: PointeroverParentEvent<T>, state: DragState<T>) => void;
    /**
...
declare function handleBlurParent<T>(_data: ParentEventData<T>, _state: BaseDragState<T> | DragState<T> | SynthDragState<T>): void;
declare function handleFocusParent<T>(data: ParentEventData<T>, state: BaseDragState<T> | DragState<T> | SynthDragState<T>): void;
...
declare function handleDropParent<T>(_data: ParentEventData<T>): void;
...
declare function handlePointerdownNode<T>(data: NodePointerEventData<T>, state: BaseDragState<T>): void;
declare function dragstartClasses<T>(_node: NodeRecord<T>, nodes: Array<NodeRecord<T>>, config: ParentConfig<T>): void;
...
declare function handleKeydownNode<T>(_data: NodeEventData<T>): void;
...
declare function handleDragoverNode<T>(data: NodeDragEventData<T>, state: DragState<T>): void;
declare function handleDragoverParent<T>(data: ParentEventData<T>, state: DragState<T>): void;
...
export { type BaseDragState, type Coordinates, type DNDPlugin, type DNDPluginData, type DragAndDrop, type DragAndDropData, type DragState, type DragStateProps, type DragendEvent, type DragendEventData, type DragstartEvent, type DragstartEventData, type EventHandlers, type NativeDragEffects, type Node, type NodeData, type NodeDragEventData, type NodeEvent, type NodeEventData, type NodeFromPoint, type NodePointerEventData, type NodeRecord, type NodeTargetData, type NodesData, type ParentConfig, type ParentData, type ParentDragEventData, type ParentEventData, type ParentFromPoint, type ParentKeydownEventData, type ParentObservers, type ParentPointerEventData, type ParentRecord, type ParentTargetData, type ParentsData, type PluginData, type PointeroverNodeEvent, type PointeroverParentEvent, type RemapFinished, type RemapFinishedData, type ScrollData, type SetupNode, type SetupNodeData, type SortEvent, type SortEventData, type SynthDragState, type SynthDragStateProps, type TearDownNode, type TearDownNodeData, type TransferEvent, type TransferEventData, addClass, addEvents, addNodeClass, addParentClass, animations, copyNodeStyle, createEmitter, dragAndDrop, dragStateProps, dragValues, dragstartClasses, emit, eventCoordinates, getElFromPoint, getRealCoords, getScrollables, handleBlurParent, handleClickNode, handleClickParent, handleDragoverNode, handleDragoverParent, handleDragstart, handleDropParent, handleEnd, handleFocusParent, handleKeydownNode, handleKeydownParent, handleLongPress, handlePointerdownNode, handlePointermove, handlePointeroverNode, handlePointeroverParent, handlePointerupNode, handleScroll, handleTouchstart, initDrag, insertion, isBrowser, isDragState, isNode, isSynthDragState, noDefault, nodeEventData, nodes, on, parentEventData, parentValues, parents, performSort, performTransfer, place, preventSortOnScroll, remapFinished, remapNodes, removeClass, resetState, setAttrs, setDragState, setParentValues, setupNode, setupNodeRemap, sort, state, swap, synthMove, tearDown, tearDownNode, tearDownNodeRemap, throttle, touchDevice, transfer, treeAncestors, updateConfig, validateDragHandle, validateDragstart, validateSort, validateTransfer };
